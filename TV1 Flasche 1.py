...
xData = np.array([0.1 , 52 , 102 ,152 , 203 , 253  , 306 , 356 , 406 , 456]) #filled water in gram almost equal to volume of the bottle
yData = np.array([165.53 , 172.23 , 180.06 , 194.52,  208.79 , 231.45 ,257.81 , 298.83 , 369.14 , 517.09 ]) #f:frequency in Hz
...
plt.title('Helmholtz Resonator Bottle 1 (Frequency^2) and (1/Air Volume) Relation')
plt.xlabel('1/V_0 /ml')
plt.ylabel('f^2 / Hz^2')
plt.legend()
plt.show()